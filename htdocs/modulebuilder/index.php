...
} // Do not check anti SQL+XSS injection attack test
    ...
    if (! $error) {
        ...
        if ($tab == 'dictionaries') {
            ...
            if ($action != 'editfile' || empty($file)) {
                ...
                if (! is_array($dicts) || empty($dicts)) {
                    print '<span class="opacitymedium">'.$langs->trans("NoDictionaries").'</span>';
                } else {
                ...
                if ($action != 'editfile' || empty($file)) {
                    try {
                        ...
                        if (function_exists('opcache_invalidate')) {
                            opcache_invalidate($dirread.'/'.$pathtoclass, true);
                        } // remove the include cache hell !
        ...
        if ($tab == 'specifications') {
            ...
            if (!dol_is_file($outputfiledoc)) {
                print '<strong>'.$langs->trans("FileNotYetGenerated").'</strong>';
            } else {
                print '<strong>';
