...
if ($filter_dateouvertureprevue != '' && $filter_opouvertureprevue == -1) {
    $filter_opouvertureprevue = '=';
}

$filter_date1=dol_mktime(0, 0, 0, $op1month, $op1day, $op1year);
if ($filter_date1 != '' && $filter_op1 == -1) {
    $filter_op1 = '=';
}

$filter_date2=dol_mktime(0, 0, 0, $op2month, $op2day, $op2year);
if ($filter_date2 != '' && $filter_op2 == -1) {
    $filter_op2 = '=';
}

$filter_datecloture=dol_mktime(0, 0, 0, $opcloturemonth, $opclotureday, $opclotureyear);
if ($filter_datecloture != '' && $filter_opcloture == -1) {
    $filter_opcloture = '=';
}
