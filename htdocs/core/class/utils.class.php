...
class Utils
{
            ...
            if ($dolibarr_main_data_root) {
                ...
                if ($choice == 'tempfilesold') {
                    ...
                    foreach ($filesarray as $key => $val) {
                        ...
                        } // Discard temp dir not older than $nbsecondsold
                    }
                }
            }
        }
    ...
    public function dumpDatabase($compression = 'none', $type = 'auto', $usedefault = 1, $file = 'auto', $keeplastnfiles = 0, $execmethod = 0)
    {
        ...
        if ($type == 'mysql' || $type == 'mysqli') {
            ...
            } // If there is spaces, we add quotes on command to be sure $command is only a program and not a program+parameters
