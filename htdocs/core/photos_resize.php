...
if (empty($backtourl)) {
    if (in_array($modulepart, array('product', 'produit', 'service', 'produit|service'))) {
        ...
        $backtourl = DOL_URL_ROOT."/comm/propal/document.php?id=".$id.'&file='.urldecode($_POST["file"]);
        ...
        $backtourl = DOL_URL_ROOT."/compta/bank/document.php?id=".$id.'&file='.urldecode($_POST["file"]);
    } elseif (in_array($modulepart, array('mrp'))) {
        $backtourl = DOL_URL_ROOT."/mrp/mo_document.php?id=".$id.'&file='.urldecode($_POST["file"]);
    } else {
        $backtourl = DOL_URL_ROOT."/".$modulepart."/".$modulepart."_document.php?id=".$id.'&file='.urldecode($_POST["file"]);
    }
}
