...
class modProduct extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        */
        ...
        if (!empty($conf->barcode->enabled)) {
            $this->import_updatekeys_array[$r] = array_merge($this->import_updatekeys_array[$r], array('p.barcode'=>'BarCode'));
        } //only show/allow barcode as update key if Barcode module enabled
