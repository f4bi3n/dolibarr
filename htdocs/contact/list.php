...
if (!empty($search_categ)) {
    $sql .= ' LEFT JOIN '.MAIN_DB_PREFIX."categorie_contact as cc ON p.rowid = cc.fk_socpeople";
...
if (!empty($search_categ_supplier)) {
    $sql .= ' LEFT JOIN '.MAIN_DB_PREFIX."categorie_fournisseur as cs2 ON s.rowid = cs2.fk_soc";
} // We need this table joined to the select in order to filter by categ
