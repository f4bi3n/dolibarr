...
if (!GETPOST('confirmmassaction', 'alpha') && $massaction != 'confirm_presend') {
    $massaction = '';
}
...
if ($search_batch) {
    $sql.= natural_search("batch", $search_batch);
}
if ($search_fk_user_creat) {
    $sql.= natural_search("fk_user_creat", $search_fk_user_creat);
}
...
if ($resql) {
    ...
    if ($search_entity != '') {
        $param .= '&amp;search_entity='.urlencode($search_entity);
    }
    if ($search_product != '') {
    ...
    if ($search_fk_user_creat != '') {
        $param .= '&amp;search_fk_user_creat='.urlencode($search_fk_user_creat);
    }
    if ($search_fk_user_modif != '') {
        $param .= '&amp;search_fk_user_modif='.urlencode($search_fk_user_modif);
    }
    if ($search_import_key != '') {
    ...
    if (!empty($arrayfields['t.entity']['checked'])) {
        print '<td class="liste_titre"><input type="text" class="flat" name="search_entity" value="'.$search_entity.'" size="8"></td>';
    }
    if (!empty($arrayfields['t.batch']['checked'])) {
        print '<td class="liste_titre"><input type="text" class="flat" name="search_batch" value="'.$search_batch.'" size="8"></td>';
    }
    if (!empty($arrayfields['t.fk_product']['checked'])) {
        print '<td class="liste_titre"><input type="text" class="flat" name="search_product" value="'.$search_product.'" size="8"></td>';
    }
    ...
    if (!empty($arrayfields['t.fk_user_creat']['checked'])) {
        print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_user_creat" value="'.$search_fk_user_creat.'" size="10"></td>';
    }
    ...
    if (!empty($arrayfields['t.batch']['checked'])) {
        print_liste_field_titre($arrayfields['t.batch']['label'], $_SERVER['PHP_SELF'], 't.batch', '', $param, '', $sortfield, $sortorder);
    }
    if (!empty($arrayfields['t.fk_product']['checked'])) {
        print_liste_field_titre($arrayfields['t.fk_product']['label'], $_SERVER['PHP_SELF'], 't.fk_product', '', $param, '', $sortfield, $sortorder);
    }
    if (!empty($arrayfields['t.sellby']['checked'])) {
        print_liste_field_titre($arrayfields['t.sellby']['label'], $_SERVER['PHP_SELF'], 't.sellby', '', $param, '', $sortfield, $sortorder);
    }
    if (!empty($arrayfields['t.eatby']['checked'])) {
        print_liste_field_titre($arrayfields['t.eatby']['label'], $_SERVER['PHP_SELF'], 't.eatby', '', $param, '', $sortfield, $sortorder);
    }
    if (!empty($arrayfields['t.fk_user_creat']['checked'])) {
        print_liste_field_titre($arrayfields['t.fk_user_creat']['label'], $_SERVER['PHP_SELF'], 't.fk_user_creat', '', $param, '', $sortfield, $sortorder);
    }
    if (!empty($arrayfields['t.fk_user_modif']['checked'])) {
        print_liste_field_titre($arrayfields['t.fk_user_modif']['label'], $_SERVER['PHP_SELF'], 't.fk_user_modif', '', $param, '', $sortfield, $sortorder);
    }
    if (!empty($arrayfields['t.import_key']['checked'])) {
        print_liste_field_titre($arrayfields['t.import_key']['label'], $_SERVER['PHP_SELF'], 't.import_key', '', $param, '', $sortfield, $sortorder);
    }
    // Extra fields
